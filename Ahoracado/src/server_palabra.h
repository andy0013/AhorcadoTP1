 ...
 * Tambien en caso de error o acierto, modificamos el puntero
 * a int de los intentos disponibles.
 */
void palabra_revisar_caracter_y_intentos(palabra *palabra_en_uso, char leido,
		int *intentos);
