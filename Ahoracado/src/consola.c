...
void consola_obtener_input_user(consola *instancia_de_consola,char *char_user){
	...
	if(!instancia_de_consola->se_cargo_input){
		...
		socket_send(instancia_de_consola->servidor_a_user, "ingrese una letra:", 18);

		instancia_de_consola->input = (char *)malloc(sizeof(char));

		socket_receive(instancia_de_consola->servidor_a_user,instancia_de_consola->input, 1);
...
void consola_mensaje_palabra_actual(consola *instancia_de_consola,char *palabra_actual){
	...
	socket_send(instancia_de_consola->servidor_a_user, palabra_actual, 4);
